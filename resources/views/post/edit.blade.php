        ...
        <div class="border-b border-gray-300 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 sm:grid-cols-6 gap-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input id="author" type="text" name="author" value="{{ old('author', $post->author) }}" class="block w-full rounded-md border {{ $errors->has('author') ? 'border-red-500' : 'border-gray-300' }} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-600"/>
                    </div>
                    @error('author')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
